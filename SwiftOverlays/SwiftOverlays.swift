...
open class SwiftOverlays: NSObject {
    ...
    */
    ...
    /**
        ...
        - returns: Created overlay
    */
    open class func showBlockingWaitOverlayWithText(_ text: NSString) -> UIView {
        let blocker = addMainWindowBlocker()
    ...
    /**
        ...
        - returns: Created overlay
    */
    open class func showBlockingImageAndTextOverlay(_ image: UIImage, text: NSString) -> UIView  {
        let blocker = addMainWindowBlocker()
    ...
    /**
        ...
        - returns: Created overlay
    */
    open class func showBlockingTextOverlay(_ text: NSString) -> UIView  {
        let blocker = addMainWindowBlocker()
    ...
    */
    ...
    open class func showGenericOverlay(_ parentView: UIView, text: NSString, accessoryView: UIView, horizontalLayout: Bool = true) -> UIView {
    ...
    open class func showProgressOverlay(_ parentView: UIView, text: NSString) -> UIView  {
    ...
    open class func updateOverlayText(_ parentView: UIView, text: NSString) {
